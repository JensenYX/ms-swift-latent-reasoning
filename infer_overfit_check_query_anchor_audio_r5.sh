#!/bin/bash
# =============================================================================
# Qwen3-Omni query-anchored CoLaR mixed audio/text overfit inference check (r=5).
# =============================================================================
set -e
...
: "${CHECKPOINT_ROOT:=${SCRIPT_DIR}/output/qwen3omni_query_anchor_hidden_r5_mse_sqrt/overfit_ckpt_audio_r5}"
: "${DATASET:=${SCRIPT_DIR}/output/qwen3omni_colar/overfit_mixed_audio_text.jsonl}"
: "${OUTPUT:=${SCRIPT_DIR}/output/qwen3omni_query_anchor_hidden_r5_mse_sqrt/overfit_infer_query_anchor_r5.jsonl}"
...
echo ">>> inference: Qwen3-Omni query-anchored CoLaR mixed audio/text overfit r=5"
