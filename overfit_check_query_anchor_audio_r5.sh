#!/bin/bash
# =============================================================================
# Query-anchored CoLaR overfit check (mixed audio/text input -> text output, r=5).
#
# This is an isolated experiment path:
#   - plugin: colar_plugin/query_anchor_plugin.py
#   - output: output/qwen3omni_query_anchor_hidden_r5_mse_sqrt
...
: "${OUTPUT_DIR:=${SCRIPT_DIR}/output/qwen3omni_query_anchor_hidden_r5_mse_sqrt}"
...
echo ">>> overfit: ${DATASET_LINES} mixed audio/text samples, query-anchor r=5, mse + sqrt_mean"
...
echo ">>> query-anchor overfit mixed audio/text (r=5) 完成"
