#!/bin/bash
# =============================================================================
# Qwen3-Omni CoLaR mixed audio/text overfit inference check (r=10).
#
# Usage:
#   bash infer_overfit_check_audio_r10.sh
#   CHECKPOINT=/path/to/checkpoint-300 bash infer_overfit_check_audio_r10.sh
# =============================================================================
set -e
...
: "${CHECKPOINT_ROOT:=${SCRIPT_DIR}/output/qwen3omni_colar_mixed_r10_mse_sqrt/overfit_ckpt_audio_r10}"
: "${DATASET:=${SCRIPT_DIR}/output/qwen3omni_colar/overfit_mixed_audio_text.jsonl}"
: "${OUTPUT:=${SCRIPT_DIR}/output/qwen3omni_colar_mixed_r10_mse_sqrt/overfit_infer_mixed_r10.jsonl}"
...
echo ">>> inference: Qwen3-Omni CoLaR mixed audio/text overfit r=10 (mode=${MODE})"
